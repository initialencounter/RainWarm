...
<template>
  <div class="file-drop">
    <!-- 头部 -->
    <el-button text class="close-icon" @click="handleHide">
      <el-icon :size="25"><CloseBold /></el-icon>
    </el-button>
    <el-button text class="git" @click="open_link('https://github.com/initialencounter/rainwarm')">
    ...
    <h1 style="font-size: 24px" class="noSelectTitle" data-tauri-drag-region> 文件 MD5 校对器 v0.0.9 </h1>
    <!-- 内容区 -->
